  ...
  return (
    <footer className="footer--container">
      <div className="footer--link--container">
        <div>
          <img src="./img/jnhlogo.png" alt="Jamal Naser H" />
        </div>
        ...
        <div className="footer--social--icon">
          <ul>
            <li>
              <a
                href="https://web.facebook.com/jamalnaseer.habibi/"
                className="navbar--content"
                target="_blank"
                rel="noreferrer"
              >
            ...
            <li>
              <a
                href="https://www.instagram.com/jamalnaserhabibi/"
                className="navbar--content"
                target="_blank"
                rel="noreferrer"
              >
            ...
            <li>
              <a
                href="mailto:jamalnaser.tech@gmail.com"
                className="navbar--content"
                target="_blank"
                rel="noreferrer"
              >
            ...
            <li>
              <a
                href="https://af.linkedin.com/in/jamalnaserhabibi"
                className="navbar--content"
                target="_blank"
                rel="noreferrer"
              >
      ...
      <div className="footer--content--container">
        <p className="footer--content">Made By Jamal Naser Habibi</p>
        <div className="footer--social--icon">Alright Reserved 2024</div>
      </div>
    </footer>
  );
}
